    ...
    <header className="sticky top-0 z-30 border-b border-line/80 bg-white/72 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 items-center justify-between gap-3 sm:flex-none sm:justify-end">
          ...
          <div className="flex items-center gap-3 rounded-full border border-line bg-white py-1 pl-1 pr-3 shadow-sm">
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-brand-100 text-sm font-bold text-brand-700">AV</div>
            <div className="hidden sm:block">
              <p className="text-xs font-semibold text-ink">Admin Vavive</p>
              <p className="text-[11px] text-slate-500">Todas as franquias</p>
            </div>
          </div>
        </div>
      </div>
