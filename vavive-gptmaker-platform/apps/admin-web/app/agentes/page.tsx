            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">{agent.franchise}</p>
                </div>
              </div>
              <StatusBadge status={agent.status} />
            </div>
            <div className="mt-5 rounded-xl bg-slate-50 p-4 text-sm text-slate-600">
              <p><strong className="text-ink">Tom:</strong> {agent.tone}</p>
              <p className="mt-1"><strong className="text-ink">Ultima sync:</strong> {agent.lastSync}</p>
            </div>
